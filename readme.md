# luci-app-easy-setup (v1.0.0 - v1.0.1)
...
#### Using wget (Standard)
```bash
opkg update && wget --no-check-certificate -O /tmp/luci-app-easy-setup_1.0.1-r1.ipk https://github.com/OppsError404/luci-app-easy-setup/releases/download/v1.0.1/luci-app-easy-setup_1.0.1-r1.ipk && opkg install /tmp/luci-app-easy-setup_1.0.1-r1.ipk && rm /tmp/luci-app-easy-setup_1.0.1-r1.ipk
```

#### Using curl (Alternative)
```bash
opkg update && curl -L -o /tmp/luci-app-easy-setup_1.0.1-r1.ipk https://github.com/OppsError404/luci-app-easy-setup/releases/download/v1.0.1/luci-app-easy-setup_1.0.1-r1.ipk && opkg install /tmp/luci-app-easy-setup_1.0.1-r1.ipk && rm /tmp/luci-app-easy-setup_1.0.1-r1.ipk
```
