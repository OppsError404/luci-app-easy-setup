...
Run the following command in your router's terminal to update the package list, download, install, and clean up:

### Using wget (Standard)
```bash
apk update && wget --no-check-certificate -O /tmp/luci-app-easy-setup-1.0.0-r1.apk https://github.com/OppsError404/luci-app-easy-setup/releases/latest/download/luci-app-easy-setup-1.0.0-r1.apk && apk add --allow-untrusted /tmp/luci-app-easy-setup-1.0.0-r1.apk && rm /tmp/luci-app-easy-setup-1.0.0-r1.apk
```

### Using curl (Alternative)
```bash
apk update && curl -L -o /tmp/luci-app-easy-setup-1.0.0-r1.apk https://github.com/OppsError404/luci-app-easy-setup/releases/latest/download/luci-app-easy-setup-1.0.0-r1.apk && apk add --allow-untrusted /tmp/luci-app-easy-setup-1.0.0-r1.apk && rm /tmp/luci-app-easy-setup-1.0.0-r1.apk
```
